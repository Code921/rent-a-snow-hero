package com.morning.rentasnowhero.generate;
...
public class CodeGenerator {
    ...
    public static void main(String[] args) throws TemplateException, IOException {
        // 指定生成参数
        String packageName = "com.morning.rentasnowhero";
        String dataName = "出租订单";
        String dataKey = "rentalOrder";
        String upperDataKey = "RentalOrder";
